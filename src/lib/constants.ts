...
export const EXPECT_CARDS = [
  ...
  },
  {
    ...
    category: "COMMUNITY",
    description: "Join a movement that elevates the entire Sikh professional ecosystem.",
    image: "/images/cards/community.jpg",
  },
];

export const CREDIBILITY_LOGOS = [
  "Google", "McKinsey", "Goldman Sachs", "Microsoft", "Deloitte", "Meta",
  "JPMorgan", "Tesla", "Amazon", "Apple",
];

export const CREDIBILITY_STATS = [
  { value: 5, suffix: "+", label: "Forbes 30 Under 30" },
  { value: 8, suffix: "+", label: "Fortune 500 Companies" },
  { value: 10, suffix: "+", label: "Founders & CEOs" },
];
