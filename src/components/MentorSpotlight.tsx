        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {mentors.map((mentor) => (
            <a
              ...
              className="bg-navy-700 rounded-xl p-8 flex flex-col items-center hover:bg-navy-600 transition-colors group"
            >
              <Image
                src={mentor.image}
                alt={mentor.name}
